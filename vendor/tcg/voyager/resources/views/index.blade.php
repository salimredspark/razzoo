                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="{{ route('voyager.contactus.index') }}" class="voyager-link">
                                    <span class="resource_label"><i class="voyager-people"></i> <span class="copy">Staff ({{ $counts['staff'] }})</span></span>
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="{{ route('voyager.contactus.index') }}" class="voyager-link">
                                    <span class="resource_label"><i class="voyager-telephone"></i> <span class="copy">Contact Request ({{ $counts['contacts'] }})</span></span>
                                </a>
                            </div>
                        </div>
